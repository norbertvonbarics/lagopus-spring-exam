...
Abstract classes cannot be initiated, subclasses are their missing pieces. If we using abstract classes, we can inherit the implementation of other non-abstract methods, we can't do it with interfaces, because interfaces cannot provide any method implementations. 
